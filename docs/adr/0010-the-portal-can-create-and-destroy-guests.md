...
**Status:** accepted · **Date:** 2026-09-04 · **Amends:** §15.4 of [docs/15-security-design.md](../15-security-design.md), the non-goals in [docs/02-prd.md §5](../02-prd.md) and [docs/01-executive-summary.md](../01-executive-summary.md), risk P1 in [docs/21-risk-assessment.md](../21-risk-assessment.md), the explicit non-roadmap in [docs/22-future-enhancements.md](../22-future-enhancements.md) · **Adds:** PROV-01…PROV-08 to [docs/03-frs.md](../03-frs.md)
...
- **Provisioning is inert until a template exists.** The cluster this was designed against currently reports zero of them. Building a cloud-init template — import a cloud image, attach a cloud-init drive, `qm template` — is a prerequisite an administrator performs on the cluster, not something the portal does.
